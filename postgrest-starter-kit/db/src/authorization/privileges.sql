...
grant select, insert, update, delete on data.ev to api;
grant select, insert, update, delete on data.evType to api;
...
grant select (id,streetID,crime,distance) on api.evs to anonymous;
grant select (id,EVType) on api.evTypes to anonymous;
-------------------------------------------------------------------------------
